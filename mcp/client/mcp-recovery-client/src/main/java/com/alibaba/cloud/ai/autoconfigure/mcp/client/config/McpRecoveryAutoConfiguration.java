...
@EnableConfigurationProperties({McpSseClientProperties.class, McpClientCommonProperties.class,
        com.alibaba.cloud.ai.autoconfigure.mcp.client.config.McpRecoveryAutoProperties.class})
@ConditionalOnProperty(prefix = com.alibaba.cloud.ai.autoconfigure.mcp.client.config.McpRecoveryAutoProperties.CONFIG_PREFIX, name = "enabled", havingValue = "true")
public class McpRecoveryAutoConfiguration {
    ...
    public McpSyncRecovery mcpSyncRecovery(McpRecoveryAutoProperties mcpRecoveryAutoProperties,
        ...
        McpSyncRecovery mcpSyncRecovery = new McpSyncRecovery(mcpRecoveryAutoProperties, mcpSseClientProperties, mcpClientCommonProperties, mcpSyncClientConfigurer);
